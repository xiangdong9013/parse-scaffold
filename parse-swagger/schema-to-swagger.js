 ...
 */
exports.parseSchemaToSwagger = function (appId, swaggerConfig, schemas) {
    for (const classes of schemas) {
        swaggerConfig.components.schemas[classes.className] = transformClasseToSchema(classes);
        swaggerConfig.paths[`/${appId}/classes/` + classes.className] = getPath(classes);
        swaggerConfig.paths[`/${appId}/classes/` + classes.className + '/{id}'] = getPathById(classes);
    }
